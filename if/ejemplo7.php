...
if($ventas > 0 && $ventas < 100){
    $mensaje = "<div class='alert alert-success' role='alert'>No tiene ningun descuento</div>";
   
}else if($ventas >= 100 && $ventas <= 500) {
    $descuento = $ventas * 0.15;
    $mensaje = "<div class='alert alert-success' role='alert'>Tiene un descuento del 15%</div>";
    
}else if ($ventas > 500 && $ventas <= 1000){
    $descuento = $ventas * 0.20;
    $mensaje = "<div class='alert alert-success' role='alert'>Tiene un descuento del 20%</div>";
}else if($ventas > 1000) {
    $mensaje = "<div class='alert alert-success' role='alert'>Tiene un descuento del 30%</div>";
    $descuento = $ventas * 0.30;
}else{
    $mensaje = "<div class='alert alert-success' role='alert'>No aplica</div>";
}
